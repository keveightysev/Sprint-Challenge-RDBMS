...
RDMS stands for "Relational DataBase Management System" and it refers to the model of how data is stored in the database, into tables that can be indexed, etc. SQL stands for "Structured Query Language" and it is the language we use to interact with RDBMS.

1. Why do tables need a `primary key`?

A primary key ensures that each row in a table has a unique value that allows us to find a specific row when we need to.
